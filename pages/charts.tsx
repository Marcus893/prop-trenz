  ...
  const handleLocationSelect = async (locationId: string) => {
    ...
    try {
      ...
      if (result.data) {
        ...
        const displayName =
          loc.name === "Benito Juárez" && loc.state === "Quintana Roo"
            ? `${loc.name} (Cancún)`
            : loc.name;
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600 capitalize">
                        {t(`navigation.${selectedLocationType}`)}{" "}
                        {t("charts.level")}
                      </p>
                    </div>
                    <div className="text-right">
                      <p className="text-sm text-gray-500">
                        {t("charts.selected_location")}
                      </p>
                    </div>
                  </div>
                </Card>
              ...
              <Card className="p-6 flex items-center justify-center h-96">
                <div className="text-center text-gray-500">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">
                    {t("charts.no_location_title")}
                  </h3>
                  <p className="text-gray-600">
                    {t("charts.no_location_help")}
                  </p>
                </div>
              </Card>
            )}
